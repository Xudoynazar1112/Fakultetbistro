    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lang_id', models.IntegerField(blank=True, choices=[(1, 'Uzbek'), (2, 'Russian')], null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='bot.category')),
            ],
        ),
        migrations.CreateModel(
            name='Order',
