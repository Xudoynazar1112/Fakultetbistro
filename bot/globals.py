...
BTN_COMMENTS = {1: "✍️Fikr bildirish", 2: "✍️комментарий"}
...
COMMENTS = {
    1: "Fikr va e'tirozlaringizni shu yerda matn ko'rinishida yozib qoldirishingiz mumkin",
    2: "Здесь вы можете написать свои комментарии и возражения в текстовом виде."
}
